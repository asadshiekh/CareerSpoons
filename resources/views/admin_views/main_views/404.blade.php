      ...
      <div class="main_container">
        ...
        <div class="col-md-12">
          <div class="col-middle">
            <div class="text-center text-center" style="color: white;margin-top: 17%;">
              <h1 class="error-number">404</h1>
              <h2>Sorry but we couldn't find this page</h2>
              <p>This page you are looking for does not exist <u><a href="#" style="color: white;">Report this?</a></u>
              </p>
            </div>
          </div>
        </div>
