					...
					<div class="col-md-8">
						<div class="left-side-container">
							...
							<div class="header-details">
								...
								<?php }else{ ?>
								<li><div class="verified-action"><span class="protip" data-pt-scheme="leaf" data-pt-gravity="top 0 -15; bottom 0 15" data-pt-title="Company is Verified" data-pt-animate="bounceIn">Verified</span></div></li>
							<?php } ?>
								</ul>
							</div>
						</div>
